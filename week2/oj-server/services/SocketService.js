...
module.exports = function (io) {
    ...
    io.on('connection',(socket)=>{
        ...
        socket.on('restoreBuffer',()=>{
           let sessionId = socketIdToSessionId[socket.id];
           console.log('resotring buffer for session:'+sessionId+',socket:'+socket.id);
           if(sessionId in collaborations){
           ...
           if(sessionId in collaborations){
               ...
               if(index >= 0){
                   ...
                   if(participants.length == 0){
                       console.log("last participant left. Strong in Rredis.");
        ...
        function forwardEvents(socketId,eventName,dataString) {
            ...
            if(sessionId in collaborations){
                ...
                console.log("WARNING: coulg not tie socket_id to any collaboration");
            }
        }
    });
}